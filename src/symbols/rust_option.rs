...
macro_rules! rust_option_shims {
    ($segment:expr, $ty:ty) => {
        ...
        const _: () = {
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$", $segment, "$set"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$", $segment, "$value"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$", $segment, "$set"))]
        ...
        const _: () = {
            /* Vec<T> impl */
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$rust_vec$", $segment, "$new"))]
            unsafe extern "C" fn __const_new(this: *mut RustOption<&RustVec<$ty>>) {
                unsafe { ptr::write(this, RustOption::<&RustVec<$ty>>::new()) };
            }
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$rust_vec$", $segment, "$drop"))]
            unsafe extern "C" fn __const_drop(this: *mut RustOption<&RustVec<$ty>>) {
                unsafe { ptr::drop_in_place(this) }
            }
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$rust_vec$", $segment, "$has_value"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$rust_vec$", $segment, "$value"))]
            unsafe extern "C" fn __const_value(this: *const RustOption<&RustVec<$ty>>) -> *const RustVec<$ty> {
                unsafe { core::ptr::from_ref(this.as_ref().unwrap().as_option().as_ref().copied().unwrap()) }
            }
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$const$rust_vec$", $segment, "$set"))]
            unsafe extern "C" fn __const_set(
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$new"))]
            unsafe extern "C" fn __new(this: *mut RustOption<&mut RustVec<$ty>>) {
                unsafe { ptr::write(this, RustOption::<&mut RustVec<$ty>>::new()) }
            }
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$drop"))]
            unsafe extern "C" fn __drop(this: *mut RustOption<&mut RustVec<$ty>>) {
                unsafe { ptr::drop_in_place(this) }
            }
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$has_value"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$value_const"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$value"))]
            ...
            #[unsafe(export_name = concat!("cxxbridge1$rust_option$rust_vec$", $segment, "$set"))]
            unsafe extern "C" fn __set(
