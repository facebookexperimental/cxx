...
#[export_name = "meta_cxxbridge1$str$new"]
...
#[cfg(feature = "alloc")]
#[export_name = "meta_cxxbridge1$str$ref"]
...
#[export_name = "meta_cxxbridge1$str$from"]
...
#[export_name = "meta_cxxbridge1$str$ptr"]
unsafe extern "C" fn str_ptr(this: &&str) -> *const u8 {
    this.as_ptr()
}

#[export_name = "meta_cxxbridge1$str$len"]
