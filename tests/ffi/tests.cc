...
rust::Option<rust::Vec<uint8_t>> c_return_rust_option_vec_native() {
  return rust::Option<rust::Vec<uint8_t>>{rust::Vec<uint8_t>{20, 24}};
}

rust::Option<rust::Vec<Shared>> c_return_rust_option_vec_shared() {
  return rust::Option<rust::Vec<Shared>>{rust::Vec<Shared>{Shared{2024}}};
}

rust::Option<rust::Vec<rust::String>> c_return_rust_option_vec_string() {
  return rust::Option<rust::Vec<rust::String>>{rust::Vec<rust::String>{"2024"}};
}
